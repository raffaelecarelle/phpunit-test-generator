...
final readonly class Psr4TestClassWriter implements TestClassWriter
{
    public function __construct(private Configuration $configuration, private Filesystem $filesystem = new Filesystem()) {}
